YUI.add('aui-diagram-node-ONAYLAMA', function (A, NAME) {

/**
 * A base class for `A.DiagramNodeONAYLAMA`.
 *
 * @class A.DiagramNodeONAYLAMA
 * @extends A.DiagramNodeState
 * @param {Object} config Object literal specifying widget configuration
 *     properties.
 * @constructor
 */
var DiagramNodeONAYLAMA = A.Component.create({
     ...
     * configuration for the `A.DiagramNodeONAYLAMA`.
     *
     * @property ATTRS
     * @type Object
     * @static
...
A.DiagramNodeONAYLAMA = DiagramNodeONAYLAMA;
