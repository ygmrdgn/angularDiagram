    ...
    prototype: {
        ...
        getPropertyModel: function() {
            ...
            return [
              ...
              {
                attributeName : 'sonuyarisuresi',
                editor: new A.TextCellEditor,
                name: 'son uyarı süresi'
              }
              ,
              {
                attributeName : 'sonislemsuresi',
                editor: new A.TextCellEditor,
                name: 'son işlem süresi'
              }
              ,
              {
                attributeName : 'islemyapilmazsa',
                editor: new A.DropDownCellEditor,
                name: 'islem yapılmazsa ne olucak ?'
              }
              ,
              {
                attributeName : 'reddurumunda',
                editor: new A.DropDownCellEditor,
                name: 'red durumunda ne olucak ?'
              }
              ,
              {
                attributeName : 'islemyapacakpersonel',
                editor: new A.DropDownCellEditor,
                name: 'islem yapacak personel ?'
              }
              ,
              {
                attributeName : 'islemyapacakunvan',
                editor: new A.DropDownCellEditor,
                name: 'islem yapacak unvan ?'
              }
              ,
              {
                attributeName : 'islemyapacakbolum',
                editor: new A.DropDownCellEditor,
                name: 'islem yapacak bolum ?'
              }
              ,
              {
                attributeName : 'islemyapilmazsa',
...
}, '3.1.0', {"requires": ["aui-aria", "aui-diagram-node-manager-base", "escape", "overlay"]});
