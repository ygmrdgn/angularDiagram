YUI.add('aui-diagram-node-IMZALAMA', function (A, NAME) {

/**
 * A base class for `A.DiagramNodeIMZALAMA`.
 *
 * @class A.DiagramNodeIMZALAMA
 * @extends A.DiagramNodeState
 * @param {Object} config Object literal specifying widget configuration
 *     properties.
 * @constructor
 */
var DiagramNodeIMZALAMA = A.Component.create({
     ...
     * configuration for the `A.DiagramNodeIMZALAMA`.
     *
     * @property ATTRS
     * @type Object
     * @static
...
A.DiagramNodeIMZALAMA = DiagramNodeIMZALAMA;
