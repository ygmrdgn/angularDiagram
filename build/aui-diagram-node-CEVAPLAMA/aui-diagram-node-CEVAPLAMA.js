YUI.add('aui-diagram-node-CEVAPLAMA', function (A, NAME) {

/**
 * A base class for `A.DiagramNodeCEVAPLAMA`.
 *
 * @class A.DiagramNodeCEVAPLAMA
 * @extends A.DiagramNodeState
 * @param {Object} config Object literal specifying widget configuration
 *     properties.
 * @constructor
 */
var DiagramNodeCEVAPLAMA = A.Component.create({
     ...
     * configuration for the `A.DiagramNodeCEVAPLAMA`.
     *
     * @property ATTRS
     * @type Object
     * @static
...
A.DiagramNodeCEVAPLAMA = DiagramNodeCEVAPLAMA;
