    ...
    ATTRS: {
        ...
        strings: {
            value: {
                ...
                cancel: 'Vazgeç',
                close: 'Kapat',
                deleteConnectorsMessage: 'Bağlantı silinsin mi ?',
                deleteNodesMessage: 'İş akışı adım silinsin mi ?',
                propertyName: 'Özellik',
                save: 'Kaydet',
                settings: 'Ayarlar',
                value: 'Değer'
            }
...
A.namespace('DiagramBuilder.types').CEVAPLAMA = A.DiagramNodeCEVAPLAMA;

A.namespace('DiagramBuilder.types').YONLENDIRME = A.DiagramNodeYONLENDIRME;

A.namespace('DiagramBuilder.types').IMZALAMA = A.DiagramNodeIMZALAMA;

A.namespace('DiagramBuilder.types').ONAYLAMA = A.DiagramNodeONAYLAMA;
    ...
    "requires": [
      ...
      "aui-diagram-node-CEVAPLAMA",
      "aui-diagram-node-YONLENDIRME",
      "aui-diagram-node-IMZALAMA",
      "aui-diagram-node-ONAYLAMA",
        "overlay"
    ],
    "skinnable": true
});
